...
// DATE: 20131212
//
// Calculates 2pt functions and Dq_(x,y,z) continuum derivatives (= "x" in FT) in momentum space using multiple radii for the FT.
...
void usage()
{
  cout << endl << "This program calculates 2pt functions and Dq_(x,y,z) continuum derivatives (i.e. factor 'x' in FT) in momentum space using multiple radii for the FT.";
