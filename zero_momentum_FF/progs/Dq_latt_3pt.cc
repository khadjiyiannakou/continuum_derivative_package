...
// DATE: 20131212
//
// Calculates 3pt functions and Dq_(x,y,z) lattice derivatives (i.e. "sin(x)" in FT) in momentum space using multiple radii for the FT
...
void usage()
{
  cout << endl << "This program calculates 3pt functions and Dq_(x,y,z) lattice derivatives (i.e. factor 'sin(x)' in FT)  in momentum space using multiple radii for the FT.";
